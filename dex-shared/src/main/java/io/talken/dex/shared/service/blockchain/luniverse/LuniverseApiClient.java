...
public class LuniverseApiClient extends AbstractRestApiService {
	...
	public RestApiResult<LuniverseWalletResponse> createWallet(String userKey) {
	...
	public RestApiResult<LuniverseWalletResponse> getWallet(String userKey) {
	...
	public RestApiResult<LuniverseWalletBalanceResponse> getWalletBalance(String address, String mainTokenSymbol) {
		return getWalletBalance(address, mainTokenSymbol, null);
	}

	public RestApiResult<LuniverseWalletBalanceResponse> getWalletBalance(String address, String mainTokenSymbol, String sideTokenSymbol) {
	...
	public RestApiResult<LuniverseTransactionResponse> requestTx(String txName, Object request) {
	...
	public RestApiResult<EthSendTransaction> submitSignedTxViaRPC(LuniverseRawTx rawTx, EthereumSignInterface signer) {
		RestApiResult<EthSendTransaction> result = new RestApiResult<>("submitSignedTxViaRPC");
