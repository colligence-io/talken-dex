...
@Component
public class SwapRefundTaskTransactionProcessor implements DexTaskTransactionHandler.TaskTransactionProcessor {
	private static final PrefixedLogger logger = PrefixedLogger.getLogger(SwapRefundTaskTransactionProcessor.class);
	...
	public DexTaskTypeEnum getDexTaskType() {
		return DexTaskTypeEnum.SWAP_REFUND;
	}
